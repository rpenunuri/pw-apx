...
```
BASE_URL=https://apexfintechsolutions.com BROWSER=chromium GROUP=@smoke docker-compose up --build
```
...
- `-u|--url`: The base URL used for all of the test cases. If not provided, `https://apexfintechsolutions.com` is used.
